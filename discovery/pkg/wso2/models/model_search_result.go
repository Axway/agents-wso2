...
func (o *SearchResult) GetTransportType() string {
...
// and a boolean to check if the value has been set.
func (o *SearchResult) GetTransportTypeOk() (*string, bool) {
	if o == nil || o.TransportType == nil {
		return nil, false
	}
...
func (o *SearchResult) HasTransportType() bool {
	if o != nil && o.TransportType != nil {
		return true
	}
...
func (o *SearchResult) SetTransportType(v string) {
	o.TransportType = &v
}
