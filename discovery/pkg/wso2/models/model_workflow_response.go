...
func NewWorkflowResponse(workflowStatus string, ) *WorkflowResponse {
...
func (o *WorkflowResponse) GetWorkflowStatus() string {
	if o == nil  {
		var ret string
		return ret
	}
...
func (o *WorkflowResponse) GetWorkflowStatusOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *WorkflowResponse) SetWorkflowStatus(v string) {
	o.WorkflowStatus = v
}

// GetJsonPayload returns the JsonPayload field value if set, zero value otherwise.
func (o *WorkflowResponse) GetJsonPayload() string {
	if o == nil || o.JsonPayload == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WorkflowResponse) GetJsonPayloadOk() (*string, bool) {
	if o == nil || o.JsonPayload == nil {
		return nil, false
	}
...
func (o *WorkflowResponse) HasJsonPayload() bool {
	if o != nil && o.JsonPayload != nil {
		return true
	}
...
func (o *WorkflowResponse) SetJsonPayload(v string) {
	o.JsonPayload = &v
}

// GetLifecycleState returns the LifecycleState field value if set, zero value otherwise.
func (o *WorkflowResponse) GetLifecycleState() LifecycleState {
...
// and a boolean to check if the value has been set.
func (o *WorkflowResponse) GetLifecycleStateOk() (*LifecycleState, bool) {
	if o == nil || o.LifecycleState == nil {
		return nil, false
	}
...
func (o *WorkflowResponse) HasLifecycleState() bool {
	if o != nil && o.LifecycleState != nil {
		return true
	}
...
func (o *WorkflowResponse) SetLifecycleState(v LifecycleState) {
	o.LifecycleState = &v
}
