...
type Deployments struct {
	...
	Clusters []DeploymentClusterInfo `json:"clusters"`
}
...
func NewDeployments(name string, clusters []DeploymentClusterInfo, ) *Deployments {
	this := Deployments{}
	this.Name = name
...
func (o *Deployments) GetClusters() []DeploymentClusterInfo {
	if o == nil  {
		var ret []DeploymentClusterInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Deployments) GetClustersOk() (*[]DeploymentClusterInfo, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Deployments) SetClusters(v []DeploymentClusterInfo) {
	o.Clusters = v
}
