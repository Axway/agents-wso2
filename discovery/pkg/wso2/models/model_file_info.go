...
func (o *FileInfo) GetRelativePath() string {
...
func (o *FileInfo) GetRelativePathOk() (*string, bool) {
	if o == nil || o.RelativePath == nil {
		return nil, false
	}
...
func (o *FileInfo) HasRelativePath() bool {
	if o != nil && o.RelativePath != nil {
		return true
	}
...
func (o *FileInfo) SetRelativePath(v string) {
	o.RelativePath = &v
}

// GetMediaType returns the MediaType field value if set, zero value otherwise.
func (o *FileInfo) GetMediaType() string {
...
// and a boolean to check if the value has been set.
func (o *FileInfo) GetMediaTypeOk() (*string, bool) {
	if o == nil || o.MediaType == nil {
		return nil, false
	}
...
func (o *FileInfo) HasMediaType() bool {
	if o != nil && o.MediaType != nil {
		return true
	}
...
func (o *FileInfo) SetMediaType(v string) {
	o.MediaType = &v
}
