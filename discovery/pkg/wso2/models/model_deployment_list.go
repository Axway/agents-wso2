...
type DeploymentList struct {
	...
	List *[]Deployments `json:"list,omitempty"`
}
...
func (o *DeploymentList) GetCount() int32 {
...
func (o *DeploymentList) GetCountOk() (*int32, bool) {
	if o == nil || o.Count == nil {
		return nil, false
	}
	return o.Count, true
...
func (o *DeploymentList) HasCount() bool {
	if o != nil && o.Count != nil {
		return true
	}
...
func (o *DeploymentList) SetCount(v int32) {
	o.Count = &v
}

// GetList returns the List field value if set, zero value otherwise.
func (o *DeploymentList) GetList() []Deployments {
	if o == nil || o.List == nil {
		var ret []Deployments
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DeploymentList) GetListOk() (*[]Deployments, bool) {
	if o == nil || o.List == nil {
		return nil, false
	}
	return o.List, true
...
func (o *DeploymentList) HasList() bool {
	if o != nil && o.List != nil {
		return true
	}
...
// SetList gets a reference to the given []Deployments and assigns it to the List field.
func (o *DeploymentList) SetList(v []Deployments) {
	o.List = &v
}
