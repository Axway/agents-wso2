...
// GetAccessUrls returns the AccessUrls field value if set, zero value otherwise.
func (o *Label) GetAccessUrls() []string {
	if o == nil || o.AccessUrls == nil {
		var ret []string
		return ret
	}
	return *o.AccessUrls
...
// GetAccessUrlsOk returns a tuple with the AccessUrls field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Label) GetAccessUrlsOk() (*[]string, bool) {
	if o == nil || o.AccessUrls == nil {
		return nil, false
	}
	return o.AccessUrls, true
}

// HasAccessUrls returns a boolean if a field has been set.
func (o *Label) HasAccessUrls() bool {
	if o != nil && o.AccessUrls != nil {
		return true
	}
...
// SetAccessUrls gets a reference to the given []string and assigns it to the AccessUrls field.
func (o *Label) SetAccessUrls(v []string) {
	o.AccessUrls = &v
}
...
func (o Label) MarshalJSON() ([]byte, error) {
	...
	if o.AccessUrls != nil {
		toSerialize["access_urls"] = o.AccessUrls
	}
