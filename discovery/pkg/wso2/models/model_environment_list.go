...
// EnvironmentList struct for EnvironmentList
type EnvironmentList struct {
	// Number of Environments returned. 
	Count *int32 `json:"count,omitempty"`
	List *[]Environment `json:"list,omitempty"`
}
...
func (o *EnvironmentList) GetCount() int32 {
...
func (o *EnvironmentList) GetCountOk() (*int32, bool) {
	if o == nil || o.Count == nil {
		return nil, false
	}
	return o.Count, true
...
func (o *EnvironmentList) HasCount() bool {
	if o != nil && o.Count != nil {
		return true
	}
...
func (o *EnvironmentList) SetCount(v int32) {
	o.Count = &v
}

// GetList returns the List field value if set, zero value otherwise.
func (o *EnvironmentList) GetList() []Environment {
	if o == nil || o.List == nil {
		var ret []Environment
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EnvironmentList) GetListOk() (*[]Environment, bool) {
	if o == nil || o.List == nil {
		return nil, false
	}
	return o.List, true
...
func (o *EnvironmentList) HasList() bool {
	if o != nil && o.List != nil {
		return true
	}
...
// SetList gets a reference to the given []Environment and assigns it to the List field.
func (o *EnvironmentList) SetList(v []Environment) {
	o.List = &v
}
