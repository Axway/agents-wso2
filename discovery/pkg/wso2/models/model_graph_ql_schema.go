...
func NewGraphQLSchema(name string, ) *GraphQLSchema {
	this := GraphQLSchema{}
	this.Name = name
	return &this
}
...
// GetSchemaDefinition returns the SchemaDefinition field value if set, zero value otherwise.
func (o *GraphQLSchema) GetSchemaDefinition() string {
	if o == nil || o.SchemaDefinition == nil {
		var ret string
		return ret
	}
...
// GetSchemaDefinitionOk returns a tuple with the SchemaDefinition field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GraphQLSchema) GetSchemaDefinitionOk() (*string, bool) {
	if o == nil || o.SchemaDefinition == nil {
		return nil, false
	}
	return o.SchemaDefinition, true
}

// HasSchemaDefinition returns a boolean if a field has been set.
func (o *GraphQLSchema) HasSchemaDefinition() bool {
	if o != nil && o.SchemaDefinition != nil {
		return true
	}
...
// SetSchemaDefinition gets a reference to the given string and assigns it to the SchemaDefinition field.
func (o *GraphQLSchema) SetSchemaDefinition(v string) {
	o.SchemaDefinition = &v
}
...
func (o GraphQLSchema) MarshalJSON() ([]byte, error) {
	...
	if o.SchemaDefinition != nil {
		toSerialize["schemaDefinition"] = o.SchemaDefinition
	}
