...
type DeploymentStatus struct {
	...
	Clusters []DeploymentClusterStatus `json:"clusters"`
}
...
func NewDeploymentStatus(type_ string, clusters []DeploymentClusterStatus, ) *DeploymentStatus {
...
func (o *DeploymentStatus) GetType() string {
	if o == nil  {
		var ret string
		return ret
	}
...
func (o *DeploymentStatus) GetTypeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Type, true
...
func (o *DeploymentStatus) SetType(v string) {
	o.Type = v
}

// GetClusters returns the Clusters field value
func (o *DeploymentStatus) GetClusters() []DeploymentClusterStatus {
	if o == nil  {
		var ret []DeploymentClusterStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetClustersOk() (*[]DeploymentClusterStatus, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *DeploymentStatus) SetClusters(v []DeploymentClusterStatus) {
	o.Clusters = v
}
