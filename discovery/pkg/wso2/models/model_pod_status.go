...
func NewPodStatus(name string, ready string, status string, ) *PodStatus {
	this := PodStatus{}
	this.Name = name
	this.Ready = ready
	this.Status = status
...
func (o *PodStatus) GetName() string {
	if o == nil  {
		var ret string
		return ret
	}
...
func (o *PodStatus) GetNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Name, true
...
func (o *PodStatus) SetName(v string) {
	o.Name = v
}

// GetReady returns the Ready field value
func (o *PodStatus) GetReady() string {
	if o == nil  {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PodStatus) GetReadyOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Ready, true
...
func (o *PodStatus) SetReady(v string) {
	o.Ready = v
}

// GetStatus returns the Status field value
func (o *PodStatus) GetStatus() string {
	if o == nil  {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PodStatus) GetStatusOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *PodStatus) GetCreationTimestampOk() (*string, bool) {
	if o == nil || o.CreationTimestamp == nil {
		return nil, false
	}
...
func (o *PodStatus) HasCreationTimestamp() bool {
	if o != nil && o.CreationTimestamp != nil {
		return true
	}
...
func (o *PodStatus) SetCreationTimestamp(v string) {
