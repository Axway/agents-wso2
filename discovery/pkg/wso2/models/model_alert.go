...
type Alert struct {
	...
	Configuration *[]AlertConfig `json:"configuration,omitempty"`
}
...
func (o *Alert) GetConfiguration() []AlertConfig {
...
// and a boolean to check if the value has been set.
func (o *Alert) GetConfigurationOk() (*[]AlertConfig, bool) {
	if o == nil || o.Configuration == nil {
		return nil, false
	}
...
func (o *Alert) HasConfiguration() bool {
	if o != nil && o.Configuration != nil {
		return true
	}
...
// SetConfiguration gets a reference to the given []AlertConfig and assigns it to the Configuration field.
func (o *Alert) SetConfiguration(v []AlertConfig) {
	o.Configuration = &v
}
