...
func (o *Error) GetError() []ErrorListItem {
...
// and a boolean to check if the value has been set.
func (o *Error) GetErrorOk() (*[]ErrorListItem, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
// SetError gets a reference to the given []ErrorListItem and assigns it to the Error field.
func (o *Error) SetError(v []ErrorListItem) {
	o.Error = &v
}
